...
describe('RepositoryService', () => {
  ...
  describe('getRandomQuote', () => {
    ...
    // it('should return a random quote for Character2', async () => {
    //   const actual = await service.getRandomQuote(['Character2']);

    //   expect(selectSpy).toHaveBeenCalled();
    //   expect(whereSpy).toHaveBeenCalled(); // <-- This isn't working
    //   expect(getOneSpy).toReturnWith(testData[1]);
    //   expect(actual).toStrictEqual(testData[1]);
    // });
  });
